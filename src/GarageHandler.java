public class GarageHandler {
	...
	//Adds a Garage which can hold maximumNumberOfVehicles to the list of Garages unless the maximum number of garages is reached. Throws a MaximumNumberOfGaragesReachedException if the maximum number of garages is reached
	...
	//Returns a String with a list of all Vehicles among the Vehicles in the Garage corresponding to the garageIndex parameter.
	public String listAllParkedVehicles(int garageIndex) {	
		...
		//Deletes the unwanted whitespace character at the end of vehicleList.
	...
	//Returns a String with a list of all VehicleTypes among the Vehicles in the Garage corresponding to the garageIndex parameter.
	public String listAllParkedVehicleTypes(int garageIndex) {	
		...
		//Deletes the unwanted whitespace character at the end of vehicleTypeList.
		if (numberOfVehicles > 0) {
	...
	public Vehicle findVehicle (String registrationNumber, int garageIndex) {
		...
		Vehicle[] vehicles = garages[garageIndex].getVehicles();
		//loops through all the vehicles in the relevant garage and searches for the ones with the right registrationNumber.
		for(int i = 0; i < numberOfVehicles; i++) {
	...
	//Removes the Vehicle corresponding to the vehicleIndex parameter from the Garage corresponding to the garageIndex parameter.
